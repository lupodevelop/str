...
pub fn kmp_maps_reuse_index_test() {
  ...
  assert core.kmp_index_of_with_maps(text1, pat, pmap, pimap) == core.kmp_index_of(text1, pat)
  assert core.kmp_index_of_with_maps(text2, pat, pmap, pimap) == core.kmp_index_of(text2, pat)
}
...
pub fn kmp_maps_reuse_search_all_test() {
  ...
  assert core.kmp_search_all_with_maps(text, pat, pmap, pimap) == core.kmp_search_all(text, pat)
}
