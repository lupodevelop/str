/// Unit tests for core string manipulation functions.
///
/// This file tests fundamental string operations from the str library:
/// - Padding and centering (pad_left, pad_right, center)
/// - Wrapping and unwrapping (surround, unwrap)
/// - Reversing (reverse)
/// - Truncating (truncate, truncate_default, truncate_preserve)
/// - Tokenization (words, chars, chars_stdlib)
/// - Starts/ends checking (starts_with, ends_with, and *_any variants)
/// - Whitespace normalization (normalize_whitespace)
/// - Counting occurrences (count with overlapping/non-overlapping modes)
///
/// These tests ensure basic functionality works correctly with:
/// - ASCII text
/// - Unicode characters (accents, emoji, combining marks)
